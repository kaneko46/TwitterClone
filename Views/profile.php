...
$view_tweets = [
    [
        ...
        'tweet_created_at' => '2021-12-25 14:00:00',
        'like_id' => null,
        'like_count' => 0,
    ],
];
                            ...
                            <div class="modal-content">
                                <form action="profile.php" method="post" enctype="multipart/form-data">
                                    ...
                                    <div class="modal-body">
                                        ...
                                        <input type="password" class="form-control mb-4" name="password" value="" placeholder="パスワードを変更する場合はご入力して下さい" minlength="4" maxlength="128">
                                    </div>
